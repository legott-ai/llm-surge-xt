...
#ifndef SURGE_SRC_COMMON_GEMINIAPICLIENT_H
#define SURGE_SRC_COMMON_GEMINIAPICLIENT_H
...
// Using Google's candidates/content/parts/text structure
struct GeminiResponse
{
    bool success = false;
    std::string errorMessage;
    std::string responseText;
    std::vector<Surge::AI::PatchModification> modifications;
};
...
class APIClient : public Surge::AI::AIModelProvider
{
  public:
    explicit APIClient(SurgeStorage *storage,
                       Surge::AI::ModelType modelType = Surge::AI::ModelType::GEMINI_3_FLASH);
    ~APIClient() override;
...
#endif // SURGE_SRC_COMMON_GEMINIAPICLIENT_H
